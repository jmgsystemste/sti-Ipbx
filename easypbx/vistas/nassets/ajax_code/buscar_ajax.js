function BuscarRegistro(inicio, cantidad, pagina) {    

    thedate = document.frmreportes.theDate.value;
    thedate1 = document.frmreportes.theDate1.value;
    extencion = document.frmreportes.extencion.value;
    ...
    ajax = objetoAjax();
    ajax.open("POST", "../modelos/mod_registros_buscar.php", true);
    ajax.onreadystatechange = function ()
    {
        ...
        var paginar = '<ul class="pagination">';
            paginar += '<li class="page-item">\n\
                                <a class="page-link" id="anterior" onclick="BuscarRegistro(0, 20, 1);">Inicial</a>\n\
                           </li>';
            paginar += '<li class="page-item"><a class="page-link" onclick="anterior_bs();">&lsaquo;&lsaquo;</a></li>';
        if (pagina_act > ver_paginado) {
            if (pagina_act == 1) {
                paginar += '<li class="page-item active"><a class="page-link" href="#">&nbsp;' + 1 + ' </a></li>';
            } else {
                paginar += '<li class="page-item"><a class="page-link" onclick="paginar_bs(1);">&nbsp;' + 1 + ' </a></li>';
            }
        ...
        for (i = pagina_act; i < control; i++) {
            ...
            if(pagina_act == 1){               
                paginar += '<li class="page-item"><a class="page-link" onclick="paginar_bs(' + (i+1) + ');">&nbsp;' + (i+1) + ' </a></li>';
            }else if(pagina_act > 1 && pagina_act < total_paginas){                
                if (i == pagina_act) {
                    paginar += '<li class="page-item active"><a class="page-link" href="#">&nbsp;' + i + ' </a></li>';
                } else {
                    paginar += '<li class="page-item"><a class="page-link" onclick="paginar_bs(' + i + ');">&nbsp;' + i + ' </a></li>';
                }               
            }else if(pagina_act == total_paginas){
                paginar += '<li class="page-item"><a class="page-link" onclick="paginar_bs(' + (total_paginas-1) + ');">&nbsp;' + (total_paginas-1) + ' </a></li>';              
            }
        }
        if (pagina_act < (total_paginas - (ver_paginado - 1))) {
            ...
            if (pagina_act == total_paginas) {
                ...
                paginar += '<li class="page-item"><a class="page-link" onclick="paginar_bs(' + total_paginas + ');">&nbsp;' + total_paginas + ' </a></li>';
            }
        ...
        paginar += '<li class="page-item"><a class="page-link" onclick="siguiente_bs();">&rsaquo;&rsaquo;</a></li>';
        paginar += '<li class="page-item">\n\
                            <a class="page-link" class="page-link" id="siguiente" onclick="BuscarRegistro(inicio_pagfin, 20, total_paginas);">Final</a>\n\
                        </li></ul>';
        if(pagina_act < total_paginas){
    ...
    ajax.send("thedate=" + thedate + "&thedate1=" + thedate1 + "&extencion=" + extencion + "&ini_reg=" + registro_ini + "&can_reg=" + paginacion_cant);
